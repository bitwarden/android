...
fun LazyListScope.vaultAddEditBankAccountItems(
    ...
    item {
        ...
        BitwardenListHeaderText(
            label = stringResource(id = BitwardenString.bank_account_details),
            modifier = Modifier
                .fillMaxWidth()
            ...
            onOptionSelected = { selectedString ->
                bankAccountHandlers.onAccountTypeSelect(
                    VaultBankAccountType
                        .entries
                        .first {
                            it.longName.toString(resources) == selectedString
                        },
                )
            },
            cardStyle = CardStyle.Middle(),
...
@Preview
@Composable
private fun VaultAddEditBankAccountItems_preview() {
    BitwardenTheme {
        LazyColumn {

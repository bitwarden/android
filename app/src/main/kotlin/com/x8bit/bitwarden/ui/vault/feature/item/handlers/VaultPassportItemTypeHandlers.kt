...
/**
 * A collection of handler functions for managing actions within the context of viewing passport
 * items in a vault.
 *
...
data class VaultPassportItemTypeHandlers(
    ...
    companion object {
        ...
        /**
         * Creates the [VaultPassportItemTypeHandlers] using the [viewModel] to send desired
         * actions.
         */

...
data class AddEditSendHandlers(
    ...
    val onEmailValueChange: (String, String) -> Unit,
    val onAddNewEmailClick: () -> Unit,
    val onEmailsRemoveClick: (String) -> Unit,
) {
    ...
    companion object {
        ...
        fun create(
            ...
            AddEditSendHandlers(
                ...
                onEmailsRemoveClick = {
                    viewModel.trySendAction(AddEditSendAction.AuthEmailRemove(id = it))
                },
            )
    }
}

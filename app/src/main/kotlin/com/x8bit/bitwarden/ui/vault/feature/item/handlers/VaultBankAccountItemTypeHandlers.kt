...
data class VaultBankAccountItemTypeHandlers(
    ...
    val onAccountNumberVisibilityClick: (Boolean) -> Unit,
    val onPinVisibilityClick: (Boolean) -> Unit,
) {
        ...
        fun create(viewModel: VaultItemViewModel): VaultBankAccountItemTypeHandlers =
            VaultBankAccountItemTypeHandlers(
                ...
                onPinVisibilityClick = {
                    viewModel.trySendAction(
                        VaultItemAction.ItemType.BankAccount.PinVisibilityClick(isVisible = it),
                    )
                },
            )
    }

 ...
 * @param fillAssistViews The list of views produced by fill-assist rule matching, or empty when
 * no rules matched this subtree.
 * @param fillAssistHostRules The fill-assist rules resolved for this subtree's host, or null when
 * no rules exist for the host or the feature flag is off.
...
data class ViewNodeTraversalData(
    ...
    val fillAssistViews: List<AutofillView> = emptyList(),
    val fillAssistHostRules: List<FillAssistRules.HostRule>? = null,

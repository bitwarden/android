...
import com.x8bit.bitwarden.ui.platform.theme.color.BitwardenColorScheme.IllustrationColors
...
/**
 * Creates a [ImageVector] and updates the path colors with the given [IllustrationColors].
 */
@Composable
private fun multiTonalVectorResource(
    @DrawableRes id: Int,
): ImageVector {
    val originalImage = ImageVector.vectorResource(id)
    return ImageVector
        .Builder(

...
class VaultItemViewModel @Inject constructor(
    ...
    private fun handlePublicKeyVisibilityClicked(
        action: VaultItemAction.ItemType.SshKey.PublicKeyVisibilityClicked,
    ) {
...
sealed class VaultItemAction {
    ...
    sealed class ItemType : VaultItemAction() {
        ...
        sealed class SshKey : ItemType() {
            /**
             * The user has clicked to display the public key.
             */
            ...
            /**
             * The user has clicked to display the fingerprint.
             */

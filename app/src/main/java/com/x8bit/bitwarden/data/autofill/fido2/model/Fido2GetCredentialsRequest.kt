...
data class Fido2GetCredentialsRequest(
     ...
     */
    val providerRequest: BeginGetCredentialRequest?
        get() = BeginGetCredentialRequest.fromBundle(requestData)
     ...
     */
    val beginGetPublicKeyCredentialOption: BeginGetPublicKeyCredentialOption?
        get() = providerRequest

    ...
    fun `when ChromeAutofillSelected action is handled the correct NavigateToBrowserAutofillSettings event is sent`() =
        runTest {
            ...
            viewModel.eventFlow.test {
                ...
                assertEquals(
                    AutoFillEvent.NavigateToBrowserAutofillSettings(BrowserReleaseChannel.CHROME_STABLE),
                    awaitItem(),
                )
                viewModel.trySendAction(
                ...
                assertEquals(
                    AutoFillEvent.NavigateToBrowserAutofillSettings(BrowserReleaseChannel.CHROME_BETA),
                    awaitItem(),
                )
            }
        }

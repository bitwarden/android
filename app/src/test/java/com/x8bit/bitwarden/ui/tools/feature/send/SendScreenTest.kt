...
class SendScreenTest : BitwardenComposeTest() {
    ...
    private var onNavigateToAddEditSendRoute: AddSendRoute? = null
    ...
    fun `on NavigateToNewSend should call onNavigateToAddEditSend`() {
        ...
        assertEquals(
            AddSendRoute(sendType = sendType, modeType = ModeType.ADD, sendId = null),
    ...
    fun `on NavigateToEditSend should call onNavigateToAddEditSend`() {
        ...
        assertEquals(
            AddSendRoute(sendType = sendType, modeType = ModeType.EDIT, sendId = sendId),
            onNavigateToAddEditSendRoute,
        )
    }

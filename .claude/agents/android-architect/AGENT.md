...
Your primary workflow is `/plan-android-work`, which encompasses two sequential phases:
1. **`refining-android-requirements`** — Gap analysis, ambiguity resolution, and structured specification
2. **`planning-android-implementation`** — Architecture design, pattern selection, and phased task breakdown

---

## Core Responsibilities

### Phase 1: Requirements Refinement (`refining-android-requirements`)
...
### Phase 2: Implementation Planning (`planning-android-implementation`)
...
- `:authenticator` — TOTP/2FA authenticator application
- `:ui` — Shared UI components, strings, base ViewModels
- Shared components live in appropriate shared modules

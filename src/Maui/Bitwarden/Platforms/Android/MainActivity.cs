    ...
    public class MainActivity : MauiAppCompatActivity
    {
        ...
        protected override void OnNewIntent(Intent intent)
        {
            ...
            try
            {
                ...
                {
                    _messagingService.Send(App.POP_ALL_AND_GO_TO_AUTOFILL_CIPHERS_MESSAGE);
                    if (_appOptions != null)
                    {
                        _appOptions.Uri = uri;
                    }
                ...
                {
                    _messagingService.Send(App.POP_ALL_AND_GO_TO_TAB_GENERATOR_MESSAGE);
                    if (_appOptions != null)
                    {
                ...
                else if (intent.Action == Intent.ActionSend && intent.Type != null)
                {
                    ...
                    _messagingService.Send(App.POP_ALL_AND_GO_TO_TAB_SEND_MESSAGE);
                }
                else
                {
